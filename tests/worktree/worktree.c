...
void test_worktree_worktree__prune_valid(void)
{
	...
	cl_git_pass(git_worktree_prune(wt, GIT_WORKTREE_PRUNE_VALID|GIT_WORKTREE_PRUNE_FORCE));
...
void test_worktree_worktree__prune_locked(void)
{
	...
	cl_git_pass(git_worktree_lookup(&wt, fixture.repo, "testrepo-worktree"));
	cl_git_pass(git_worktree_lock(wt, NULL));
	cl_git_fail(git_worktree_prune(wt, GIT_WORKTREE_PRUNE_FORCE|GIT_WORKTREE_PRUNE_VALID));
...
void test_worktree_worktree__prune_gitdir(void)
{
	...
	cl_git_pass(git_worktree_lookup(&wt, fixture.repo, "testrepo-worktree"));
	cl_git_pass(git_worktree_prune(wt, GIT_WORKTREE_PRUNE_FORCE|GIT_WORKTREE_PRUNE_VALID));
...
void test_worktree_worktree__prune_both(void)
{
	...
	cl_git_pass(git_worktree_lookup(&wt, fixture.repo, "testrepo-worktree"));
	cl_git_pass(git_worktree_prune(wt, GIT_WORKTREE_PRUNE_FORCE|GIT_WORKTREE_PRUNE_WORKING_TREE | GIT_WORKTREE_PRUNE_VALID));
